...
async def photo_handler(update, context):
    ...
    if state == "back_photo":
        ...
        guest["hotel_name"] = context.user_data[
            "hotel_name"
        ]
...
def main():
    ...
    # Flask يحتاج نفس event loop في webhook.
    # لذلك نستخدم Flask عبر Hypercorn/Gunicorn في Render.
    flask_app.run(
        host="0.0.0.0",
        port=PORT,
        threaded=True
